...
MY_CLASS_NAME="ParallelMapperImpl"
MY_CLASS_NAME_2="IterativeParallelism"
MY_PACKAGE_NAME="concurrent"
TESTER_CLASS="Tester"
TESTER_JAR_2="IterativeParallelismTest"
TESTER_JAR="ParallelMapperTest"
TESTER_PACKAGE_NAME="mapper"
...
OURCLASS_2=$PACKAGE.$MY_CLASS_NAME_2
...
case $1 in
    ...
    jar )
        ...
        ;;
    run )
        java -cp "$ARTIFACTS:$BUILDDIR" $TESTER_PACKAGE.$TESTER_CLASS $2 $OURCLASS,$OURCLASS_2 "$3"
        ;;
    run-jar )
